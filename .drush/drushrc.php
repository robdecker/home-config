...
$command_specific['sql-dump'] = array('result-file' => TRUE,'gzip' => TRUE, 'structure-tables-key' => 'common');

$command_specific['sql-sync'] = array('structure-tables-key' => 'common', 'no-cache' => TRUE, 'create-db' => TRUE);

$command_specific['uli'] = array('browser' => 0);
